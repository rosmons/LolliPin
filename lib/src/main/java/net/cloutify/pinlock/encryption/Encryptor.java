package net.cloutify.pinlock.encryption;
...
/**
 * Used by {@link net.cloutify.pinlock.managers.AppLockImpl} to get the SHA1
...
public class Encryptor {
     ...
     * Select {@link Algorithm#SHA256} in {@link net.cloutify.pinlock.managers.AppLockImpl#setPasscode(String)}
