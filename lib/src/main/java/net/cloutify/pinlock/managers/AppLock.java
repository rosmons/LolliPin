package net.cloutify.pinlock.managers;

import android.app.Activity;

import net.cloutify.pinlock.encryption.Encryptor;
...
public abstract class AppLock {
    ...
    /**
     * EXTRA_TYPE, uses to pass to the {@link com.cloutify.lib.managers.AppLockActivity}
     ...
     * take into account for the {@link com.cloutify.lib.PinActivity}. These activities
     * will not log the last opened time, will not launch the
     * {@link com.cloutify.lib.managers.AppLockActivity} etc...
     */
    ...
    /**
     * Get logo resource id used by {@link com.cloutify.lib.managers.AppLockActivity}
     */
    public abstract int getLogoId();

    /**
     * Set logo resource id used by {@link com.cloutify.lib.managers.AppLockActivity}
     */
    public abstract void setLogoId(int logoId);

    /**
     * Get the forgot option used by {@link com.cloutify.lib.managers.AppLockActivity}
     */
    public abstract boolean shouldShowForgot(int appLockType);

    /**
     * Set the forgot option used by {@link com.cloutify.lib.managers.AppLockActivity}
     */
    ...
    /**
     * Enable the {@link com.cloutify.lib.managers.AppLock} by setting
     * {@link com.cloutify.lib.managers.AppLockImpl} as the
     * {@link LifeCycleInterface}
     */
    public abstract void enable();

    /**
     * Disable the {@link com.cloutify.lib.managers.AppLock} by removing any
     * {@link LifeCycleInterface}
     */
    ...
    /**
     * Evaluates if:
     * - we are already into the {@link com.cloutify.lib.managers.AppLockActivity}
     * - the passcode is not set
     * - the timeout didn't reached
     * If any of this is true, then we don't need to start the
     * {@link com.cloutify.lib.managers.AppLockActivity} (it returns false)
