...
import net.cloutify.pinlock.PinActivity;
import net.cloutify.pinlock.PinCompatActivity;
import net.cloutify.pinlock.PinFragmentActivity;
import net.cloutify.pinlock.encryption.Encryptor;
import net.cloutify.pinlock.enums.Algorithm;
...
public class AppLockImpl<T extends AppLockActivity> extends AppLock implements LifeCycleInterface {
    ...
    /**
     * The {@link android.content.SharedPreferences} key used to store the {@link net.cloutify.pinlock.enums.Algorithm}
     */
